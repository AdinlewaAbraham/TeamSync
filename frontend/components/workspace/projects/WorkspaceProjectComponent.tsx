  ...
  if (activeWorkspace)
    return (
      <div className="w-full rounded-lg border border-border-default bg-bg-primary py-4">
        ...
        <div>
          <div className="group flex cursor-pointer items-center px-4 py-2 hover:bg-menuItem-hover">
            <i className="mr-2 flex h-12 w-12 items-center justify-center rounded-lg border border-dashed border-muted-dark text-lg group-hover:border-white group-hover:text-white">
              <IoMdAdd />
            </i>
